...
import { getAnchorProgram, getNetworkUrl } from "./anchorUtils";
...
export const handleCreateNft = async (
    ...
    const umi = createUmi(getNetworkUrl(process.env.NEXT_PUBLIC_REACT_APP_SOLANA_NETWORK!)).use(mplTokenMetadata()).use(walletAdapterIdentity(wallet as any));
